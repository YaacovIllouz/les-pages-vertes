...
$msge.='<meta http-equiv="refresh" content="2; url=accueil.php?page=?.liste_part" />';		 
}
$statut=1;

$query_pag_data = "SELECT * from $table ORDER BY nom ASC";
//echo $query_pag_data;
...
<script language=javascript>
   function ConfirmMessage( identifiant ) 
   {
	   ...
	   { // Clic sur OK
           document.location.href = "accueil.php?page=?.liste_part&com="+identifiant ;
       }
   }
</script>
...
<div style="margin:auto">
  <table width="100%" border="0">
      <tr>
        <td width="43%" align="left"><h3 class="titre_page">LISTE DES PARTENAIRES</h3></td>
        <td width="25%" align="center"><?php echo $msge;?></td>
        <td width="32%" align="right"><div align="right" class="text_bouton"><a href="accueil.php?page=?.add_part" class="ajout">[Ajouter un partenaire]</a></div></td>
      </tr>
  </table>   
    </div>
<br />
			<!-- header --><!-- main content -->
                  <div class="row-fluid">
				    <div class="span12">
						  <table class="table table-bordered table-striped table_vam" id="dt_gal_">
							  <thead>
								  <tr>
		...
		?> 
								  <tr>
                                      ...
                                      <td align="center">
                                      <img src="../../<?php echo $row['logo'];?>" width="45" height="40"></td>
									  <td style="width:60px"> <?php echo $row['nom'];?>  </td>
									  <td align="center">
										  &nbsp;&nbsp;&nbsp;<a href="accueil.php?page=?.edit_part&com=<?php echo $row['id'];?>" class="lien_com"><img src="img/modifier.png" border="0" title="MODIFIER"/></a>&nbsp;&nbsp;&nbsp;
										  <a href="accueil.php?page=?.statut_part&id=<?php echo $row['id'];?>"><?php if($row['flag_part']==1){echo '<img src="img/unlocked.png" title="Cliquer pour v&eacute;rouiller">';} else {echo '<img src="img/locked_.png" title="Cliquer pour d&eacute;v&eacute;rouiller">' ;}?></a>&nbsp;&nbsp;&nbsp;
