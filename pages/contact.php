...
<div class="col-md-4">
    ...
    <img src="<?= $p['image']; ?>" class="img-responsive img-rounded border" alt="Pub" />
    <?php }?>
</div><!--col-md-4"-->

<div class="col-md-8">
    <div class="titre_droit" style="border-radius: 5px;"><b>NOUS CONTACTER<b></div><br/>
...
$message .= 'MESSAGE:'.$passage_ligne.$passage_ligne.strip_tags($msg);
            ...
            if(isEmail($email)){
                ...
                if($envoi){
                  echo '<div><h5 class="alert alert-success">Votre message a &eacute;t&eacute; 
                  prise en compte. Nous vous revenons sous peu.<br> Merci et &agrave; bient&ocirc;t.</h5></div>';
                }
                else{
        ...
        <form method="post" class="form-horizontal" style="margin:5px;">
            ...
            <div class="form-group">
              <div class="col-lg-7" style="padding:0;">
                  <input type="submit" name="btnMsg" class="btn btn-success active" value="Soumettre" style="border-radius: 5px;">
              </div>
            </div>
