...
//include_once("../_fonctions/url.inc.php");
	...
	if(isset($_GET['term']) && !empty($_GET['term'])) {
        ...
        $ese = $db->query("SELECT DISTINCT sigle, entreprise FROM entreprise WHERE (sigle LIKE '%".$term."%' OR entreprise LIKE '%".$term."%') AND flag_ese=1 ORDER BY sigle ASC")->fetchAll();
