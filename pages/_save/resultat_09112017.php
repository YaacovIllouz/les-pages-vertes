          ...
          <div class="col-md-9">
               <b style="color:#060;">
                   <a href="index.php?page=det_ese&id=<?php echo $row_rs_search['Id_ese'].'&'.format_url($row_rs_search['sigle']).':'.format_url($row_rs_search['entreprise']).'/'.format_url(GetLibcateg($row_rs_search['Id_rubrique'])).'/'.format_url(GetLibRub($row_rs_search['Id_sous_rubrique'])).'/annuaire-agriculture-lespagesvertes'; ?>">
                       <span style="font-weight:bold; color:#000; font-size:17px;"><?php echo $row_rs_search['sigle']; ?></span><br />
                       <span style="font-weight:bold; color:#000; font-size:16px;"><?php echo mb_strtoupper($row_rs_search['entreprise']); ?></span>
                   </a>
               </b>
                <br />
                <p>
            ...
            <img src="<?= $row_rs_search['image']; ?>" class="img-responsive" alt="Logo" width="80" height="80" style="max-height:80px; max-width:80px" />
           </div>
