...
if (isset($_POST['img_up']))
{
     ...
     if($Upload->CheckUpload())
     {
		if($Upload->WriteFile())
		{
            ...
            $updateSQL = sprintf("UPDATE pub_site SET image=%s, `position`=%s WHERE Id=%s",
...
<form action="<?php echo $editFormAction; ?>" enctype="multipart/form-data" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="file" name="userfile"  value="<?php echo htmlentities($row_rs_mod_site['image'], ENT_COMPAT, ''); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
