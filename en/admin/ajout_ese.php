        ...
        <form action="<?php echo $editFormAction; ?>" enctype="multipart/form-data" method="post" name="form1" id="form1">
            <table align="center" >
				...
				<tr valign="baseline">
				  ...
				  <td><input type="text" name="lien_video" size="45" />
				</tr>
				<tr valign="baseline">
				  <td><b>Etat video</b> </td>
				  <td><div align="left" valign="middle" nowrap="nowrap">
								<span class="important">Actif</span>
								<input type="radio" name="etat_video" id="radio1" value="1" >
								<span class="important">Inactif</span>
								<input type="radio" name="etat_video" id="radio2" value="0" checked >
