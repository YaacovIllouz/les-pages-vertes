  ...
  <?php do { ?>
    <tr bgcolor="#F0F0F0">
      ...
      <td align="center" valign="middle" bgcolor="#F0F0F0"><a href="index.php?page=ajout_agence&id=<?php echo $row_rs_ese['Id_ese']; ?>"><span style="color:#090;"><b>Ajouter une agence</b></span></a></td>
        ...
        <td align="center" valign="middle"><a href="index.php?page=mod_logo&id=<?php echo $row_rs_ese['Id_ese'];
			?>"><span style="color:#090;"><b>Modifier le logo</b></span></a></td>
      <td align="center" valign="middle"><a href="index.php?page=mod_ese&id=<?php echo
		  $row_rs_ese['Id_ese']; ?>" style="color: #090;"><b>Modifier</b></a></td>
      <td width="40" align="center" valign="middle"><a href="index.php?page=sup_ese&id=<?php echo
		  $row_rs_ese['Id_ese']; ?>" style="color: #090;"><b>Supprimer</b></a></td>
    </tr>
     ...
     <?php if($row_rs_ese = mysql_fetch_assoc($rs_ese)) {?>
      ...
      <td align="center" valign="middle"><a href="index.php?page=ajout_agence&id=<?php echo $row_rs_ese['Id_ese'];
		  ?>"><span style="color:#090;"><b>Ajouter une agence</b></span></a></td>
     ...
     <td align="center" valign="middle"><a href="index.php?page=ajout_pub2&id=<?php echo $row_rs_ese['Id_ese']; ?>"><span style="color:#090;"><b>Ajouter une pub</b></span></a></td>
         ...
         <a href="index.php?page=mod_logo&id=<?php echo $row_rs_ese['Id_ese']; ?>">
			 <span style="color:#090;"><b>Modifier le logo</b></span></a>
         </td>
      <td align="center" valign="middle"><a href="index.php?page=mod_ese&id=<?php echo $row_rs_ese['Id_ese'];
		  ?>" style="color: #090;"><b>Modifier</b></a></td>
      <td align="center" valign="middle"><a href="index.php?page=sup_ese&id=<?php echo $row_rs_ese['Id_ese'];
		  ?>"  style="color: #090;"><b>Supprimer</b></a></td>
    </tr>
