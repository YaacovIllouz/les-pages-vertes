...
if (isset($_POST['img_up']))
{
  ...
  $updateSQL = sprintf("UPDATE pub2 SET images=%s WHERE Id=%s",
...
mysql_select_db($database_annuaire, $annuaire);
$query_rs_mod_pub = sprintf("SELECT Id, images FROM pub2 WHERE Id = %s", GetSQLValueString($colname_rs_mod_pub, "int"));
...
<form action="<?php echo $editFormAction; ?>" enctype="multipart/form-data" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="file" name="userfile" value="<?php echo htmlentities($row_rs_mod_pub['images'], ENT_COMPAT, ''); ?>" size="32"></td>
    </tr>
    <tr valign="baseline">
