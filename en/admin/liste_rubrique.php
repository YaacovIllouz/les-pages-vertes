          ...
          <?php do { ?>
            <tr>
              ...
              <td align="center" valign="middle" style="width: 5%;">
                  <a href="index.php?page=mod_rubrique&id=<?php echo $row_rs_liste['Id']; ?>"
                     class="btn btn-info btn-sm" title="Modifer" style="color:#090;">
                      <b>Modifier</b>
                  </a>
              </td>
              <td align="center" valign="middle" style="width: 5%;">
                  <a href="index.php?page=sup_rubrique&id=<?php echo $row_rs_liste['Id']; ?>"
                     class="btn btn-danger btn-sm" title="Supprimer" style="color:#090;">
                      <b>Supprimer</b>
                  </a>
              </td>
            </tr>
