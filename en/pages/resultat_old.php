...
<div class="col-md-4">
  ...
  <?php foreach ($search as $row_rs_search) { ?>
       <div class="row" style="min-height:100px; border:1px solid <?= $row_rs_search['color']; ?>; margin-bottom:10px; border-radius:10px;">
          ...
          <div class="col-md-9">
              <b style="color:#060;">
                  <a href="index.php?page=det_ese&id=<?= $row_rs_search['Id_ese']; ?>">
                      <span style="color:#000; font-size:20px;"><?php echo $row_rs_search['sigle']; ?></span><br />
                      <span style="color:#000; font-size:16px;"><?php echo minToMajSansAccent($row_rs_search['entreprise']); ?></span>
                  </a>
              </b>
              <br />
              <p>
           ...
           <div class="col-md-12" style="background:<?= $row_rs_search['color'];
            ...
            <p style="float:right; margin-top:6px; height:15px;"><a href="index.php?page=det_ese&id=<?php echo $row_rs_search['Id_ese']; ?>">
