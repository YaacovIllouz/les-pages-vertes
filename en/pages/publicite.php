<?php
$pub = $db->query("SELECT * FROM pub_site WHERE position = 'Annonce' ORDER BY Id DESC LIMIT 0,1")->fetchAll();
/*if(!$pub){
...
<div class="col-md-4 ">
   ...
   <img src="<?php echo $p['image']; ?>" class="img-responsive pub_gauche" />
   <?php } ?>
</div><!--col-md-3"-->
...
<div class="col-md-8">
    ...
    <div style="float:left;"><br />
        <img src="../images/Format publicite.jpg" width="500" height="643" />
        <h6 class="title">
            <b>
