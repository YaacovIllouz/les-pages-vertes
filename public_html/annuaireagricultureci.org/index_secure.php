...
if($_POST) {
$test = $_POST['entreprise'];}

?>
<!doctype html>
<html lang="fr">
<head>
    <title>Lespagesvertes - Annuaire de l'agriculture de Cote d'Ivoire</title>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12" style="padding:3px;">
            ...
            <div class="col-md-2" style="padding:5px 0 0 0;">
                <div style="float:right;">
                    <a href="index.php" title="Version Fran&ccedil;aise"><img src="images/fr.png" width="30" height="30" alt="FR" style="margin-bottom: 5px"></a><br/>
        ...
        <div class="col-md-12" style="margin:20px 0 20px 0;">
            ...
            <div class="flash">
                <marquee scrollamount="3" onMouseOut="this.start();" onMouseOver="this.stop();" >
                    ...
                    if($flash){
                        foreach ($flash as $f) { ?>
                       <b style="font-size:20px;"><?php echo $f['contenu']; ?></b>
