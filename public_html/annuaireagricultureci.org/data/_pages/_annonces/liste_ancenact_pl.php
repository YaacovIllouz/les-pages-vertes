...
$msge.='<meta http-equiv="refresh" content="2; url=accueil.php?page=?.liste_ancenact_pl" />';		 
}
$statut=1;

$query_pag_data = "SELECT * from $table WHERE flag_defil=0 ORDER BY date_ance DESC";
//echo $query_pag_data;
...
<script language=javascript>
   ...
   {
       if (confirm("Voulez-vous supprimer cette bande defilante ?")) 
	   { // Clic sur OK
           document.location.href = "accueil.php?page=?.liste_ancenact_pl&com="+identifiant ;
       }
   }
</script>
...
<div style="margin:auto">
    <table width="100%" border="0">
      <tr>
        <td width="51%" align="left"><h3 class="titre_page">PANNEAU LUMINEUX NON ACTIVE</h3></td>
        <td width="25%" align="center"><?php echo $msge;?></td>
        <td width="24%"><div align="right" class="text_bouton"><a href="accueil.php?page=?.add_ance" class="ajout">[Ajouter une annonce]</a></div></td>
      </tr>
    </table>   
    </div>
<br />
						  ...
						  <table class="table table-bordered table-striped table_vam" id="dt_gal">
							  <thead>
								  <tr>
                                      ...
                                      <th width="30">CONTACTS</th>                                      <th width="1">MOTIF</th>
								  ...
								  <tr>
                                    ...
                                    <td><?php echo $row['qsfaire'];?></td>
									  ...
									  <td align="center">
										  ...
										  <a href="accueil.php?page=?.statut_plum&id=<?php echo $row['id_ance'];?>"><?php if($row['flag_defil']==1){echo '<img src="img/unlocked.png" title="Cliquer pour v&eacute;rouiller">';} else {echo '<img src="img/locked_.png" title="Cliquer pour d&eacute;v&eacute;rouiller">' ;}?></a>&nbsp;&nbsp;&nbsp;
