...
<div style="margin:auto">
    <table width="100%" border="0">
      <tr>
        <td width="33%" align="left"><h3 class="titre_page">LISTE DES ANNONCES</h3></td>
        <td width="20%" align="center"><?php echo $msge;?></td>
        <td width="47%"><div align="right" class="text_bouton"><a href="accueil.php?page=?.add_ance" class="ajout">[Ajouter une annonce]</a></div></td>
      </tr>
    </table>   
    </div>
<br />
          ...
          <table class="table table-bordered table-striped table_vam" id="dt_gal">
              <thead>
                  <tr>
                      ...
                      <th width="20" class="table_checkbox">TITRE</th>
		...
		?> 
								  <tr>
								    ...
								    <td class="gras maj"><?php echo date("d/m/Y",strtotime($row['date']));?></td>
									  
								    <td><?php echo $row['contact'].' <br/> '.$row['email'];?></td>
                                    <td align="center">
									    &nbsp;&nbsp;&nbsp;<a href="accueil.php?page=?.edit_ance&com=<?php echo $row['Id'];?>" class="lien_com"><img src="img/modifier.png" border="0" title="MODIFIER"/></a>&nbsp;&nbsp;&nbsp;
									    <a href="accueil.php?page=?.statut_ance&id=<?php echo $row['Id'];?>"><?php if($row['etat']==1){echo '<img src="img/unlocked.png" title="Cliquer pour v&eacute;rouiller">';} else {echo '<img src="img/locked_.png" title="Cliquer pour d&eacute;v&eacute;rouiller">' ;}?></a>&nbsp;&nbsp;&nbsp;
