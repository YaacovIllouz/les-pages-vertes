...
$msge.='<meta http-equiv="refresh" content="2; url=accueil.php?page=?.liste_ance" />';		 
}
$statut=1;

$query_pag_data = "SELECT * from $table WHERE flag_defil=0 OR flag_defil=1 ORDER BY date_ance DESC";
//echo $query_pag_data;
...
<script language=javascript>
   function ConfirmMessage( identifiant ) 
   {
	   ...
	   { // Clic sur OK
           document.location.href = "accueil.php?page=?.liste_ref_act&com="+identifiant ;
       }
   }
</script>
...
<div style="margin:auto">
    <table width="100%" border="0">
      <tr>
        <td width="55%" align="left"><h3 class="titre_page">GESTION DES ANNONCES DU PANNEAU LUMINEUX </h3></td>
        <td width="21%" align="center"><?php echo $msge;?></td>
        <td width="28%"><div align="right" class="text_bouton"><a href="accueil.php?page=?.add_ance" class="ajout">[Ajouter une annonce]</a></div></td>
      </tr>
    </table>   
    </div>
<br />
		...
		?> 
								  <tr>
									  <td class="rouge"><?php echo $row['qsfaire'];?></td>
                                      <td align="center"><strong><?php echo $row['titre_ance'];?></strong></td>
									  <td style="width:60px">
								    ...
								    <td><?php echo $row['tel'].' / '.$row['email'];?></td>
									  <td align="center">
										  &nbsp;&nbsp;&nbsp;
                                          <a href="accueil.php?page=?.edit_ance&com=<?php echo $row['id_ance'];?>" class="lien_com"><img src="img/modifier.png" border="0" title="MODIFIER"/>
                                          </a>&nbsp;&nbsp;&nbsp;
										  <a href="accueil.php?page=?.statut_pl&id=<?php echo $row['id_ance'];?>"><?php if($row['flag_defil']==1){echo '<img src="img/unlocked.png" title="Cliquer pour v&eacute;rouiller">';} else {echo '<img src="img/locked_.png" title="Cliquer pour d&eacute;v&eacute;rouiller">' ;}?></a>&nbsp;&nbsp;&nbsp;
