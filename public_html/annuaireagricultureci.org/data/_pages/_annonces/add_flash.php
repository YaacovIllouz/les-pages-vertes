...
if($_POST['valider'])
{
$check_flash=mysql_query("SELECT * FROM flash WHERE titre ='".$titre."' AND contenu ='".$contenu."' ");
	$nbre_flash = mysql_num_rows($check_flash);
	
	if($nbre_flash==0) {
	
	$insertion = "INSERT INTO flash VALUES
('', 
'".$titre."', 
'".$date."', 
'".$contenu."', 
'".$etat."'
	...
	}else $msge = '<h3 class="refuse">VOUS AVEZ DEJA POSTE CETTE ANNONCE!</h3>';
