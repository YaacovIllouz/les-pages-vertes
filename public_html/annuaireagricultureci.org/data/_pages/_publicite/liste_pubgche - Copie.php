...
$msge.='<meta http-equiv="refresh" content="2; url=accueil.php?page=?.liste_pubgche" />';		 
}
$statut=1;
...
<br />
		...
		?> 
                                  ...
                                  <img src="../../<?php echo $row['image'];?>" width="40" height="40"></td>
								    ...
								    <td class="rouge"><?php echo 'Du '.date("d/m/Y",strtotime($row['date_deb_pub'])).' au '.date("d/m/Y",strtotime($row['date_fin_crea']));?></td>
									  <td align="center">
										  ...
										  <a href="accueil.php?page=?.statut_pubgche&id=<?php echo $row['id_pub'];?>"><?php if($row['flag_pub']==1){echo '<img src="img/unlocked.png" title="Cliquer pour v&eacute;rouiller">';} else {echo '<img src="img/locked_.png" title="Cliquer pour d&eacute;v&eacute;rouiller">' ;}?></a>&nbsp;&nbsp;&nbsp;
