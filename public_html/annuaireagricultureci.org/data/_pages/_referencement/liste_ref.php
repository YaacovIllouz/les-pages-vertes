...
$query_pag_data = "SELECT * from $table ORDER BY sigle ASC";
//echo $query_pag_data;
...
<div style="margin:auto">
  <table width="100%" border="0">
      <tr>
        <td width="36%" align="left"><h3 class="titre_page">LISTE DES REFERENCEMENTS</h3></td>
        <td width="22%" align="center"><?php echo $msge;?></td>
        <td width="42%" align="right"><div align="right" class="text_bouton"><a href="accueil.php?page=?.add_ref" class="ajout">[Ajouter un referencement]</a></div></td>
      </tr>
    </table>   
    </div>
<br />
		...
		?> 
								  <tr>
									  <td align="center"><a href="accueil.php?page=?.add_agence&id=<?php echo $row['Id_ese'] ?>" title="Cliquez pour ajouter une agence" ><img src="../../<?php echo $row['image'];?>" width="45" height="40"></a></td>
									  <td style="width:60px">
										  <strong><a href="accueil.php?page=?.add_agence&id=<?php echo $row['Id_ese'] ?>" title="Cliquez pour ajouter une agence" ><?php echo $row['sigle'];?></a></a>
								    ...
								    <td><a href="accueil.php?page=?.add_pub&id=<?php echo $row['Id_ese'];?>" class="lien_com"><b>Ajouter une pub</b></a></td>
									  ...
									  <td align="center">
										  ...
										  <a href="accueil.php?page=?.statut_ref&id=<?php echo $row['Id_ese'];?>"><?php if($row['flag_ese']==1){echo '<img src="img/unlocked.png" title="Cliquer pour v&eacute;rouiller">';} else {echo '<img src="img/locked_.png" title="Cliquer pour d&eacute;v&eacute;rouiller">' ;}?></a>&nbsp;&nbsp;&nbsp;
