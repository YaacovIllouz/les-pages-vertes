...
<div style="margin:auto">
  <table width="100%" border="0">
      <tr>
        <td width="46%" align="left"><h3 class="titre_page">LISTE DES REFERENCEMENTS</h3></td>
...
<br />
		...
		?> 
								  <tr>
								    ...
								    <td><a href="accueil.php?page=?.ajout_pubgauche_ese&id=<?php echo $row['Id_ese'];?>" class="lien_com"><b>Ajouter pub</b></a></td>
