    ...
    <article class="module width_full">
        <header>
            <h3><b>Ajouter une entreprise</b></h3>
        </header>
    ...
    if($verif){
        ...
        if ($Upload->CheckUpload()) {
            if ($Upload->WriteFile()) {
				...
				$flag_ese=1;
                echo $insertSQL = sprintf("INSERT INTO entreprise (sigle, entreprise, image, `date`, tel1, tel2, cel1, fax, certification, marque, membre, email, web, bp, geoloclaisation, activite,lien_video, etat_video, Id_rubrique, Id_sous_rubrique, flag_ese) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" enctype="multipart/form-data" method="post" name="form1" id="form1">
  <table align="center">
      <tr valign="baseline">
          ...
          <td><input type="file" name="userfile" value="" size="40" /></td>
      </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Sigle :</b></td>
      <td><input type="text" name="sigle" id="sigle" value="" size="40" /></td>
    </tr>
     <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Entreprise :</b></td>
      <td><input type="text" name="entreprise" id="entreprise" value="" size="40" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Téléphone 1 :</td>
      <td><input type="text" name="tel1" value="+225" size="40" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Téléphone 2 :</b></td>
      <td><input type="text" name="tel2" value="+225" size="40" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Cellulaire 1 :</b></td>
      <td><input type="text" name="cel1" value="+225" size="40" /></td>
    </tr>
        <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Fax :</td>
      <td><input type="text" name="fax" value="+225" size="40" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Certification :</b></td>
      <td><textarea id="editor3" name="certification" cols="50" rows="5"></textarea></td>
    </tr>
     <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Marque :</b></td>
      <td><textarea id="editor4" name="marque" cols="50" rows="5"></textarea> </td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Membre :</b></td>
      <td><input type="text" name="membre" value="" size="40" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="web" value="http://" size="40" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Boite postale :</b></td>
      <td><input type="text" name="bp" value="" size="40" /></td>
    </tr> 
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Situation géographique :</b></td>
      <td><input type="text" name="geoloclaisation" value="" size="40" /></td>
    </tr>
    <!--<tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Dirigeant :</b></td>
      <td><textarea id="editor2" name="dirigeant" cols="50" rows="5"></textarea></td>
    </tr>-->
    <tr valign="baseline">
      <td nowrap="nowrap" align="left" valign="middle"><b>Activite :</b></td>
      <td><textarea id="editor1" name="activite" cols="50" rows="2"></textarea></td>
    </tr>
    <tr valign="baseline">
