...
<div class="col-md-4">
    <?php
    $pub = $db->query("SELECT image FROM pub_site WHERE position = 'Gauche' ORDER BY Id DESC")->fetch();
    if($pub) { ?>
        <img src="<?php echo $pub['image']; ?>"  class="img-responsive pub_gauche" />
    <?php }?>
</div><!--col-md-3"-->
<div class="col-md-8">
    <div class="titre_droit"><b>OUR AGENCIES / OUR SITES</b></div><br />
    <?php
    foreach ($agence as $row_rs_agence) { ?>
        <div class="col-md-12"
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="width:120px;"><b style="margin-left:20px;">Adress</b></td>
                    <td>
                ...
                <tr>
                    <td><b style="margin-left:20px;">Phone</b></td>
                ...
                <tr>
                    <td><b style="margin-left:20px;">Mobile</b></td>
