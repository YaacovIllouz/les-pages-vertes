<?php
    ...
    $pub_gauche = $db->query("SELECT image FROM pub_site WHERE position = 'Gauche' ORDER BY Id DESC LIMIT 0,1")->fetch();
?>
...
<div class="col-md-8">
    ...
    <!-- derniere annoncee -->
    <div>
        <div class="titre_droit" style="border-radius:3px; font-weight: bold;">LATEST COMPANIES ADDED</div>
...
/*
        //DERNIERES ANNONCES
            ...
            if($select){
                ...
                ATEST ADVERTISING<span style=" float: right;"><a href="?page=annonce" style="color:#fff;"> See more</a>&nbsp;</span></div><br/>';
                    ...
                    */?><!--
                    <div class="col-md-12" style="min-height:100px; border:1px solid #090; margin-bottom:10px; border-radius:10px; padding:0px;">
                        ...
                        <div style="padding:5px 10px;">
                            <div style="color:#000;">
                                <b>Enterprise : <?/*= $row_rs_annonce['entreprise']; */?></b><br />
                                <b>Phone : <?/*= $row_rs_annonce['contact']; */?></b> <br/>
                ...
                <span style="float:left; margin-top:3px; height:15px;color:#FFF;">
                    Published on <?/*= '<b>'.reverseDateFr($date[0]). '</b>';*/?>
                </span>
