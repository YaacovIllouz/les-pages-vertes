...
if (isset($_POST['btn_dup'])) {
    ...
    if(!empty($id_rub) && !empty($id_sou) && $rs) {
        ...
        $insertSQL = sprintf("INSERT INTO entreprise (sigle, entreprise, image, date, tel1, tel2, cel1, fax, certification, marque, membre, email, web, bp, geoloclaisation, activite, Id_rubrique, Id_sous_rubrique, flag_ese) 
