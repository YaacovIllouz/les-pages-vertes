<article class="module width_full">
    <header>
        <h3><b>AJOUTER UNE PUBLICITE :: FICHE ENTREPRISE</b></h3>
    </header>
     ...
     if($Upload->CheckUpload()) {
		if($Upload->WriteFile()) {
            ...
            $insertSQL = sprintf("INSERT INTO pub_site (image, date, position) VALUES (%s, %s, %s)",
                       ...
                       GetSQLValueString('Pub Fiche', "text"));
...
$query_rs_pub = "SELECT * FROM pub_site WHERE position='Pub Fiche'";
        ...
        <table width="100%" class="tablesorter" cellspacing="0">
            ...
            <tr>
                <th colspan="4" align="center"><h3><span style="color: #090; font-size:14px;">
                    <b>LA LISTE DES PUB FICHE ENTREPRISE</b></span></h3>
                </th>
            </tr>
          <tr>
          ...
          <?php do { ?>
            <tr>
              ...
              <td align="center" valign="middle">
                  <a href="index.php?page=pub_bas&del=<?php echo $row_rs_pub['Id']; ?>"><b>Supprimer</b></a></td>
            </tr>
