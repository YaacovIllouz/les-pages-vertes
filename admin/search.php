		...
		if($totalRows_rs_r_ese >0) {
			do { ?>
				<tr>
					...
					<td align="center" valign="middle"><a
							href="index.php?page=ajout_agence&id=<?php echo $row_rs_r_ese['Id_ese']; ?>"><b>Ajouter une
								agence</b></a></td>
					<td align="center" valign="middle"><a
							href="index.php?page=mod_logo&id=<?php echo $row_rs_r_ese['Id_ese']; ?>"><b>Modifier le
								logo</b></a></td>
					<td><a href="index.php?page=mod_ese&id=<?php echo $row_rs_r_ese['Id_ese']; ?>"><span
								class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
					<td><a href="index.php?page=sup_ese&id=<?php echo $row_rs_r_ese['Id_ese']; ?>"><span
								class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
				</tr>
				<?php
			} while ($row_rs_r_ese = mysql_fetch_assoc($rs_r_ese));
		}else{
			echo '<tr><td><h1 style="color: red; text-align: center"><b>AUCUN RESULTAT TROUVE</b></h1></td></tr>';
		}
		?>
</table>
<?php 
