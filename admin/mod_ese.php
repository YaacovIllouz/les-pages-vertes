...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	...
	$etat_video = $_POST['etat_video'];
	
	$geoloclaisation =  ($_POST['geoloclaisation']);
            $updateSQL = sprintf("UPDATE entreprise SET sigle=%s, entreprise=%s, tel1=%s, tel2=%s, cel1=%s, fax=%s, certification=%s, marque=%s, membre=%s, email=%s, web=%s, bp=%s, geoloclaisation=%s, activite=%s, lien_video=%s, etat_video=%s, Id_rubrique=%s, Id_sous_rubrique=%s WHERE Id_ese=%s",
                       ...
                       GetSQLValueString($geoloclaisation, "text"),
                       /*GetSQLValueString($_POST['dirigeant'], "text"),*/
                       GetSQLValueString($activite, "text"),
					   GetSQLValueString($lien_video, "text"),
					   GetSQLValueString($etat_video, "text"), 
...
mysql_select_db($database_annuaire, $annuaire);
$query_rs_mod_ese = sprintf("SELECT Id_ese, sigle, entreprise, image, tel1, tel2, cel1, fax, certification, marque, membre, email, web, bp, geoloclaisation, dirigeant, activite, Id_rubrique, Id_sous_rubrique, lien_video, etat_video FROM entreprise WHERE Id_ese = %s", GetSQLValueString($colname_rs_mod_ese, "int"));
...
<h3>MODIFIER LES INFORMATIONS SUR l'ENTREPRISE <span style="color: #090; font-size:14px;"><?php echo utf8_encode($row_rs_mod_ese['sigle']); ?> </span>de la catégorie <span style="color: #090; font-size:14px;"><?php 
				   mysql_select_db($database_annuaire, $annuaire);
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" enctype="multipart/form-data">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="sigle" value="<?php echo htmlentities(utf8_decode($row_rs_mod_ese['sigle']), ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Entreprise</b></td>
      <td><input type="text" name="entreprise" value="<?php echo htmlentities(utf8_decode($row_rs_mod_ese['entreprise']), ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Téléphone 1</b></td>
      <td><input type="text" name="tel1" value="<?php echo htmlentities($row_rs_mod_ese['tel1'], ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap">Téléphone 2</b> </td>
      <td><input type="text" name="tel2" value="<?php echo htmlentities($row_rs_mod_ese['tel2'], ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Cellulaire</b></td>
      <td><input type="text" name="cel1" value="<?php echo htmlentities($row_rs_mod_ese['cel1'], ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Fax</b></td>
      <td><input type="text" name="fax" value="<?php echo htmlentities($row_rs_mod_ese['fax'], ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="marque" cols="50" rows="5" id="editor4"><?php echo htmlentities(utf8_decode($row_rs_mod_ese['marque']), ENT_COMPAT, ''); ?></textarea></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Membre</b></td>
      <td><input type="text" name="membre" value="<?php echo htmlentities($row_rs_mod_ese['membre'], ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>E-mail</b></td>
      <td><input type="text" name="email" value="<?php echo htmlentities($row_rs_mod_ese['email'], ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Site web</b></td>
      <td><input type="text" name="web" value="<?php echo htmlentities($row_rs_mod_ese['web'], ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Boite postale</b></td>
      <td><input type="text" name="bp" value="<?php echo htmlentities($row_rs_mod_ese['bp'], ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Situation géographique</b> </td>
      <td><input type="text" name="geoloclaisation" value="<?php echo htmlentities(utf8_decode($row_rs_mod_ese['geoloclaisation']), ENT_COMPAT, ''); ?>" size="45" /></td>
    </tr><!--
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="activite" cols="50" rows="5" id="editor2"><?php echo htmlentities(utf8_decode($row_rs_mod_ese['activite']), ENT_COMPAT, ''); ?></textarea></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap"><b>Lien vidéo</b></td>
      <td><input type="text" name="lien_video" value="<?php echo htmlentities($row_rs_mod_ese['lien_video'], ENT_COMPAT, ''); ?>" size="45" />
    </tr>
	<tr valign="baseline">
      <td><b>Etat video</b> </td>
      <td><div align="left" valign="middle" nowrap="nowrap">
                    <span class="important">Actif</span>
                    <input type="radio" name="etat_video" id="radio1" value="1" checked="<?php if($row_rs_mod_ese['etat_video']==1) echo "checked"; ?> >
                    <span class="important">Inactif</span>
                    <input type="radio" name="etat_video" id="radio2" value="0" <?php if(($row_rs_mod_ese['etat_video']==0)||($row_rs_mod_ese['lien_video']==""))  echo "checked"; ?> >
