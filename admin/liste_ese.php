...
<article class="module width_full">
  ...
  <?php do { ?>
    <tr bgcolor="#F0F0F0">
      ...
      <td align="center" valign="middle" bgcolor="#F0F0F0"><a href="index.php?page=mod_ese&id=<?php echo $row_rs_ese['Id_ese']; ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
      <td width="40" align="center" valign="middle" bgcolor="#F0F0F0"><a href="index.php?page=sup_ese&id=<?php echo $row_rs_ese['Id_ese']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
    </tr>
     ...
     <td align="center" valign="middle"><a href="index.php?page=ajout_pub2&id=<?php echo $row_rs_ese['Id_ese']; ?>"><span style="color:#090;"><b>Ajouter une pub</b></span></a></td>
      ...
      <td align="center" valign="middle"><a href="index.php?page=mod_ese&id=<?php echo $row_rs_ese['Id_ese']; ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
      <td align="center" valign="middle"><a href="index.php?page=sup_ese&id=<?php echo $row_rs_ese['Id_ese']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
    </tr>
